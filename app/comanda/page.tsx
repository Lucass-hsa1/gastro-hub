...
const statusFlow = {
  pending: { label: 'Pendente', color: 'bg-yellow-100 text-yellow-800 border-yellow-300', icon: Clock, next: 'preparing' as OrderStatus, nextLabel: 'Iniciar Preparo' },
  preparing: { label: 'Preparando', color: 'bg-blue-100 text-blue-800 border-blue-300', icon: ChefHat, next: 'ready' as OrderStatus, nextLabel: 'Marcar Pronto' },
  ready: { label: 'Pronto', color: 'bg-green-100 text-green-800 border-green-300', icon: CheckCircle2, next: 'delivered' as OrderStatus, nextLabel: 'Entregar' },
  delivered: { label: 'Entregue', color: 'bg-gray-100 text-gray-600 border-gray-300', icon: Truck, next: 'delivered' as OrderStatus, nextLabel: '' },
  canceled: { label: 'Cancelado', color: 'bg-red-100 text-red-600 border-red-300', icon: X, next: 'canceled' as OrderStatus, nextLabel: '' },
}
